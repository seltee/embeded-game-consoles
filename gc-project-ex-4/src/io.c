...
void initIO()
{
    ...
    gpio_set_drive_strength(GPIO_SPI0_SCK, GPIO_DRIVE_STRENGTH_8MA);
    gpio_set_function(GPIO_SPI0_MOSI, GPIO_FUNC_SPI);
    gpio_set_drive_strength(GPIO_SPI0_MOSI, GPIO_DRIVE_STRENGTH_8MA);
    gpio_set_function(GPIO_SPI0_MISO, GPIO_FUNC_SPI);
    gpio_set_drive_strength(GPIO_SPI0_MISO, GPIO_DRIVE_STRENGTH_8MA);
    ...
    // Input buttons
    gpio_init(GPIO_INPUT_LOAD);
    gpio_set_dir(GPIO_INPUT_LOAD, GPIO_OUT);
    gpio_set_drive_strength(GPIO_INPUT_LOAD, GPIO_DRIVE_STRENGTH_8MA);
    gpio_init(GPIO_INPUT_SCK);
    gpio_set_dir(GPIO_INPUT_SCK, GPIO_OUT);
    gpio_set_drive_strength(GPIO_INPUT_SCK, GPIO_DRIVE_STRENGTH_8MA);
    gpio_init(GPIO_INPUT_IN);
    gpio_set_dir(GPIO_INPUT_IN, GPIO_IN);
